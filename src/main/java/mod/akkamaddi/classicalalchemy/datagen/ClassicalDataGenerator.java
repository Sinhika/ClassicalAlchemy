    ...
    public static void gatherData(GatherDataEvent event)
    {
        ...
        gen.addProvider(event.includeServer(), 
            	new SimpleLootTableProvider(packOutput, List.of(
            			new LootTableProvider.SubProviderEntry(ClassicalLootTableSubprovider::new, LootContextParamSets.BLOCK),
                		new LootTableProvider.SubProviderEntry( ClassicalAlchemyLootInjectorSubprovider::new, LootContextParamSets.CHEST)
                )));
     } // end gatherData()
