...
public class FusionRecipes extends AbstractFusionRecipeProvider implements IConditionBuilder, ISimpleConditionBuilder
{
    ...
    protected void registerCuprumRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        catalysts[1] = Ingredient.fromItems(Items.BONE_MEAL);
        catalysts[2] = Ingredient.fromItems(Items.GUNPOWDER);
        ...
        fusionbuilder.buildFusionRecyclingRecipes(consumer, Ingredient.fromItems(ModItems.cuprum_axe.get(), 
                ...
                Ingredient.fromItems(ModItems.cuprum_chestplate.get(), ModItems.cuprum_leggings.get()),
                Ingredient.fromItems(Blocks.GRAVEL), Ingredient.fromTag(ItemTags.COALS), 
    ...
    protected void registerStannumRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        fusionbuilder.buildFusionRecyclingRecipes(consumer, Ingredient.fromItems(ModItems.stannum_axe.get(), 
                ...
                Ingredient.fromItems(ModItems.stannum_chestplate.get(), ModItems.stannum_leggings.get()),
                Ingredient.fromItems(Blocks.GRAVEL), Ingredient.fromTag(ItemTags.COALS), 
    ...
    protected void registerPyropusBronzeRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        primary_inputs.add(Ingredient.fromItems(ModItems.cuprum_ingot.get()));
        primary_inputs.add(Ingredient.fromItems(ModItems.stannum_ingot.get()));
        ...
        fusionbuilder.buildFusionRecyclingRecipes(consumer, Ingredient.fromItems(ModItems.pyropus_bronze_axe.get(), 
                ...
                Ingredient.fromItems(ModItems.pyropus_bronze_chestplate.get(), ModItems.pyropus_bronze_leggings.get()),
                Ingredient.fromItems(Blocks.GRAVEL), Ingredient.fromTag(ItemTags.COALS), 
    ...
    protected void registerPulchrumBronzeRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        primary_inputs.add(Ingredient.fromItems(ModItems.pyropus_bronze_ingot.get()));
        ...
        fusionbuilder.buildFusionRecyclingRecipes(consumer, Ingredient.fromItems(ModItems.pulchrum_bronze_axe.get(), 
    ...
    protected void registerTombBronzeRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        primary_inputs.add(Ingredient.fromItems(ModItems.pyropus_bronze_ingot.get()));
        primary_inputs.add(Ingredient.fromTag(ModTags.Items.INGOTS_ARSENIDE_BRONZE));
        catalysts[0] = Ingredient.fromItems(Items.ROTTEN_FLESH);
        catalysts[1] = Ingredient.fromItems(Items.REDSTONE);
        ...
        fusionbuilder.buildFusionRecyclingRecipes(consumer, Ingredient.fromItems(ModItems.tomb_bronze_axe.get(), 
                ...
                Ingredient.fromItems(ModItems.tomb_bronze_chestplate.get(), ModItems.tomb_bronze_leggings.get()),
                Ingredient.fromItems(Blocks.GRAVEL), Ingredient.fromItems(Items.ROTTEN_FLESH), 
