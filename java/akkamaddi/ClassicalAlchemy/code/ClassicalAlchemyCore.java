...
public class ClassicalAlchemyCore
{
    ...
    @SidedProxy(clientSide = "akkamaddi.ClassicalAlchemy.code.ClientProxy", 
...
// Tab
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        .setHardness(4.0F).setResistance(8.0F).setStepSound(Block.soundTypeMetal)
        .setBlockName("blockStannum");
        blockCuprum = new SimpleBlock( Material.iron).modId("classicalalchemy")
        .setCreativeTab(ClassicalAlchemyCore.tabAkkamaddiClassicalAlchemy)
        .setHardness(8.0F).setResistance(16.0F).setStepSound(Block.soundTypeMetal)
        .setBlockName("blockCuprum");
        blockPyropusBronze = new SimpleBlock( Material.iron).modId("classicalalchemy")
        .setCreativeTab(ClassicalAlchemyCore.tabAkkamaddiClassicalAlchemy)
        .setHardness(10.0F).setResistance(18.0F).setStepSound(Block.soundTypeMetal)
        .setBlockName("blockPyropusBronze");
        blockPulchrumBronze = new SimpleBlock( Material.iron).modId("classicalalchemy")
        .setCreativeTab(ClassicalAlchemyCore.tabAkkamaddiClassicalAlchemy)
        .setHardness(8.0F).setResistance(20.0F).setStepSound(Block.soundTypeMetal)
        .setBlockName("blockPulchrumBronze");
        blockTombBronze = new SimpleBlock( Material.iron).modId("classicalalchemy")
        .setCreativeTab(ClassicalAlchemyCore.tabAkkamaddiClassicalAlchemy)
        .setHardness(12.0F).setResistance(24.0F).setStepSound(Block.soundTypeMetal)
